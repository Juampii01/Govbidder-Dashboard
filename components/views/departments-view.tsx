...
function DeptCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-border bg-card p-5 transition-all hover:border-border hover:shadow-[0_0_30px_rgba(15,23,42,0.04)]">
        ...
        <div className="flex-1 min-w-0">
          ...
          {isAdmin ? (
            <textarea
              ...
              className="mt-1 w-full bg-transparent text-[12px] text-muted-foreground placeholder:text-slate-300 outline-none resize-none border-b border-transparent hover:border-border focus:border-border transition-colors"
            />
          ) : (
            <p className="text-[12px] text-muted-foreground mt-0.5 line-clamp-2">{dept.description || "Sin descripción"}</p>
          )}
        </div>
      </div>
        ...
        <div className="flex items-center justify-between gap-2 pt-3 border-t border-border">
          <div className="flex items-center gap-2">
            <label className="flex items-center gap-1.5 text-[11px] text-muted-foreground">
              ...
              <input
                ...
                className="w-14 rounded-md border border-border bg-card px-1.5 py-0.5 text-[11px] text-foreground outline-none focus:border-border"
              />
            </label>
            <input
              type="color"
          ...
          {confirmDelete ? (
            ...
            <button
              ...
              className="flex items-center gap-1 rounded-lg px-2 py-1 text-[11px] text-muted-foreground hover:text-red-600 hover:bg-red-50 transition-all"
      ...
      <div className="space-y-6">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border bg-card">
          <div className="pointer-events-none absolute inset-0">
            ...
            <div className="absolute -bottom-24 -left-24 h-[300px] w-[300px] rounded-full bg-muted/40 blur-[100px]" />
          </div>
