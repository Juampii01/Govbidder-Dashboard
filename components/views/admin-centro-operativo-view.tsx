        ...
        if (line.match(/^- /)) {
          return (
            <div key={i} className="flex items-start gap-2 pl-2 py-0.5">
              <span className="h-1.5 w-1.5 rounded-full bg-card/20 flex-shrink-0 mt-2" />
          ...
          <div className="flex items-center gap-2">
            {editing ? (
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-xl bg-muted px-4 py-1.5 text-xs font-semibold text-foreground hover:bg-slate-200 transition-colors border border-border"
              >
  ...
  return (
    <div className="space-y-4">
      ...
      <div className={`flex items-start gap-3 rounded-2xl border p-4 ${section.accent}`}>
        ...
        <span className="text-[10px] font-semibold text-slate-300 bg-muted rounded-full px-2.5 py-1 flex-shrink-0">
          {items.length}
        </span>
      </div>
