    ...
    <Portal>
      ...
      <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="pointer-events-none absolute -bottom-32 -left-32 h-[260px] w-[260px] rounded-full bg-muted/40 blur-[80px]" />
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <ChevronRight className="h-4 w-4 text-slate-300 group-hover:text-muted-foreground transition-colors shrink-0" />
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <input
            ...
            className="h-9 rounded-xl border border-border bg-muted px-4 text-sm text-foreground placeholder:text-slate-300 focus:border-[#1e3a8a]/40 focus:outline-none flex-1 min-w-[220px] max-w-sm"
          />
          <div className="flex items-center gap-1.5">
