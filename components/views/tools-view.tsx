...
function BidCalculator() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-2xl border border-[#1e3a8a]/20 bg-gradient-to-br from-[#1e3a8a]/[0.04] to-card p-5 space-y-3">
...
function ResourceCard({ link }: { link: ResourceLink }) {
  return (
    ...
    >
      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-muted ring-1 ring-slate-200 group-hover:bg-[#1e3a8a]/[0.06] group-hover:ring-[#1e3a8a]/20 transition-all">
