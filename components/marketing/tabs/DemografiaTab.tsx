    ...
    >
      ...
      <div className="text-center max-w-sm">
        ...
        <p className="text-xs leading-relaxed" style={{ color: 'var(--muted-foreground)' }}>
          La distribución por edad, género y ciudad requiere la API de Insights
          de Instagram, que necesita aprobación de Meta App Review con permisos
          avanzados de análisis de audiencia.
        </p>
      </div>
    </div>
  )
