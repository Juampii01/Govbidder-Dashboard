            ...
            {phase === "upload" && (
              <>
                ...
                >
                  ...
                  <p className="text-[13.5px] font-bold text-foreground">Soltá un archivo CSV o hacé click</p>
                ...
                <div className="mt-3 rounded-xl border border-border bg-muted/50 p-3">
                  ...
                  <div className="space-y-1.5">
                    {rows.slice(0, 3).map((r, i) => (
                      <div key={i} className="rounded-md bg-card p-2 text-[11px] text-foreground border border-border">
                        {columns
                          ...
                          .map(c => (
                            <div key={c.field} className="flex gap-2">
                              ...
                              <span className="text-foreground truncate">{r[mapping[c.field]] || "—"}</span>
                            </div>
                          ))}
                      </div>
                    ))}
