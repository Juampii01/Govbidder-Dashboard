...
const KIND_COLOR: Record<string, string> = {
  ...
  task_mention:  "bg-amber-500/10 text-amber-600",
  task_overdue:  "bg-[#E42D2C]/10 text-[#E42D2C]",
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute top-1.5 right-1.5 flex h-4 min-w-[16px] items-center justify-center rounded-full bg-[#E42D2C] px-1 text-[9px] font-bold text-white tabular-nums ring-2 ring-card">
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-[380px] overflow-hidden rounded-2xl border border-border bg-popover shadow-[0_20px_40px_rgba(15,23,42,0.10)] z-50">
